...
from utils.openai import classify_lease, format_classification_results
...
with tab1:
    ...
    with col1:
        ...
        extract_button = st.button("Extract Text", type="primary", disabled=not openai_key)
        ...
        if extract_button and uploaded_file:
            ...
            try:
                ...
                if method and extracted_text:
                    ...
                    formatted_results, df, df2, df3 = format_classification_results(classification_results)
                    ...
                    if classification_results.get('classification') != 'ERROR':
                        ...
                        st.download_button("📄 Download classification report", data=report_data, file_name=f"{uploaded_file.name}_classification_report.txt", mime="text/plain")
